---
title: "TripAdviser_TopicModeling"
author: "Tomonori Masui"
date: "March 15, 2016"
output: html_document
---

###1. Initial Configulation
...
graphics <- function(out_cloud, out_dist) {
  ...
  topic_dist <- data.frame(x=colMeans(posterior(results)[[2]]),
  y=c("Topic1","Topic2","Topic3","Topic4","Topic5","Topic6","Topic7","Topic8","Topic9","Topic10"))
